  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 relative">
      ...
      <div className="min-h-screen flex flex-col lg:flex-row relative z-10">
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-gradient-to-br from-white/60 to-white/20 backdrop-blur-sm">
          <div className="w-full max-w-xl">
            ...
            {/* Stats */}
            <div className="flex items-center justify-around bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-gray-100/50">
              <div className="text-center">
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
          <div className="w-full max-w-md">
            <div className="bg-white/90 backdrop-blur-xl border border-gray-100/50 rounded-3xl shadow-2xl shadow-gray-200/20 p-6 lg:p-10">
              {/* Login Header */}
              <div className="text-center mb-8">
                <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-red-800 to-red-900 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-red-800/25 transform rotate-3">
                  <Users className="w-8 h-8 lg:w-10 lg:h-10 text-white transform -rotate-3" />
                </div>
              ...
              <button
                onClick={handleLogin}
                className="group w-full flex items-center justify-center py-4 lg:py-5 px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-lg lg:text-xl font-semibold rounded-2xl shadow-xl shadow-blue-600/30 hover:shadow-blue-600/50 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500/30 hover:scale-105 transform active:scale-95"
              >
                <svg className="w-6 h-6 lg:w-7 lg:h-7 mr-3 lg:mr-4 group-hover:scale-110 transition-transform duration-200" viewBox="0 0 24 24" fill="none">
              ...
              {/* Security Notice */}
              <div className="mt-6 lg:mt-8 p-4 lg:p-5 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-100">
                <div className="flex items-center space-x-3 text-green-800">
                  ...
                  <span className="font-medium text-sm lg:text-base">Secure authentication powered by Microsoft</span>
                </div>
              </div>

              {/* Footer */}
              <div className="mt-8 lg:mt-10 text-center space-y-2 lg:space-y-3">
